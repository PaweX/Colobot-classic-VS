...
This repository contains the source files of Colobot game released on open source license (GNU GPLv3) by the producer Epsitec CH.
The sources were released and the rights granted to a group of Polish Colobot fans (now TerranovaTeam). This repository contains only the source code of the game. The necessary data files are available as a separate download: https://colobot.info site.
